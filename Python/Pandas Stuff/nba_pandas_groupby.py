...
# 5. Print unpacked list of 3-letter NBA Team codes
...
#Create iterable list of 3-letter Team codes
...
while op == False:
	...
	#Unpack 'tm_lst' and separate it for readability while printing
	print(*tm_lst, sep = ' | ')
