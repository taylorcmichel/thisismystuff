...
# 2. Deconstruct the 'Instructors' data table
# 3. Create an additional table with pertinent data from the first
# 4. Delete or 'drop' the columns containing references to images
# 5. Reconstruct the original table using the two 'new' tables
# 
...
result.to_csv(filepath + 'instructors_result_concat.csv')
